     ...
     <div class="ccAccordion white">
        <ul>
           <li>
             ...
             <div class="content">
                  <?php if (!empty($content['field_blog_billeder'])):?>
                     <?php print render($content['field_blog_billeder']); ?>
                  <?php endif;?>
             </div>
           </li>
        </ul>
      </div>
    <?php /*  <div class="ccAccordion white">
           <ul>
              <li>
                 <p class='title'>
                         <a href="#" class="head">
