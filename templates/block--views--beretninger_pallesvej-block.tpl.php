  ...
  <span class="sectionShadow"></span>
     <div class="row">
      ...
      <div class="large-3 columns">
        ...
        <p style="padding-top: 13px;  margin-bottom: 0;" class="right"><a href="/beretninger/pallesvej">Se flere beretninger</a></p>
...
<section class="section-reports">
  <?php print $content ?>
</section> <!-- /view block--views--beretninger_pallesvej-block.tpl.php -->
